...
type LocationRepo interface {
	...
	StoreLocation(ctx context.Context, rideID string, location location.Location) error

	// GetLastLocation gets the last stored location for a ride
	GetLastLocation(ctx context.Context, rideID string) (*location.Location, error)
