...
// NewLocationGW creates a new location gateway with API key authentication
func NewLocationGW(locationServiceURL string, config *models.APIKeyConfig) *LocationClient {
