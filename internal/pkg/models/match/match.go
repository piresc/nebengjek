...
type Match struct {
	...
	DriverLocation     location.Location    `json:"driver_location" db:"driver_location"`
	PassengerLocation  location.Location    `json:"passenger_location" db:"passenger_location"`
	TargetLocation     location.Location    `json:"target_location" db:"target_location"`
...
// MatchDTO is used for database operations to flatten the nested location.Location structs
...
type MatchProposal struct {
	...
	UserLocation   location.Location    `json:"location"`
	DriverLocation location.Location    `json:"driver_location"`
	TargetLocation location.Location    `json:"target_location"`
