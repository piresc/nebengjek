...
func TestNotification_JSONTags(t *testing.T) {
	...
	// NotificationHistory
	assert.Equal(t, "id", getJSONTag(&NotificationHistory{}, "ID"))
	assert.Equal(t, "user_id", getJSONTag(&NotificationHistory{}, "UserID"))
	assert.Equal(t, "type", getJSONTag(&NotificationHistory{}, "Type"))
	assert.Equal(t, "data", getJSONTag(&NotificationHistory{}, "Data"))
	assert.Equal(t, "timestamp", getJSONTag(&NotificationHistory{}, "Timestamp"))
	assert.Equal(t, "delivered", getJSONTag(&NotificationHistory{}, "Delivered"))
	assert.Equal(t, "created_at", getJSONTag(&NotificationHistory{}, "CreatedAt"))
	assert.Equal(t, "updated_at", getJSONTag(&NotificationHistory{}, "UpdatedAt"))
	
	// UserNotification
	assert.Equal(t, "user_id", getJSONTag(&UserNotification{}, "UserID"))
	assert.Equal(t, "type", getJSONTag(&UserNotification{}, "Type"))
	assert.Equal(t, "data", getJSONTag(&UserNotification{}, "Data"))
	assert.Equal(t, "timestamp", getJSONTag(&UserNotification{}, "Timestamp"))
	
	// NotificationDeliveryEvent
	assert.Equal(t, "user_id", getJSONTag(&NotificationDeliveryEvent{}, "UserID"))
	assert.Equal(t, "type", getJSONTag(&NotificationDeliveryEvent{}, "Type"))
	assert.Equal(t, "data", getJSONTag(&NotificationDeliveryEvent{}, "Data"))
	assert.Equal(t, "timestamp", getJSONTag(&NotificationDeliveryEvent{}, "Timestamp"))
	assert.Equal(t, "delivery_id", getJSONTag(&NotificationDeliveryEvent{}, "DeliveryID"))
}