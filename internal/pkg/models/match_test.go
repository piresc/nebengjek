...
func TestMatch_ToDTO_ToMatch_RoundTrip(t *testing.T) {
	...
	assert.Equal(t, originalMatch.DriverLocation.Timestamp, recoveredMatch.DriverLocation.Timestamp)
	...
	assert.Equal(t, originalMatch.PassengerLocation.Timestamp, recoveredMatch.PassengerLocation.Timestamp)
	...
	assert.Equal(t, originalMatch.TargetLocation.Timestamp, recoveredMatch.TargetLocation.Timestamp)
...
func TestMatch_DefaultValues(t *testing.T) {
	...
	assert.Equal(t, Location{}, match.DriverLocation)
	assert.Equal(t, Location{}, match.PassengerLocation)
	assert.Equal(t, Location{}, match.TargetLocation)
...
func TestMatchProposal_Structure(t *testing.T) {
	proposal := &MatchProposal{
		...
		UserLocation:   Location{Latitude: -6.1751, Longitude: 106.8650},
		DriverLocation: Location{Latitude: -6.2088, Longitude: 106.8456},
		TargetLocation: Location{Latitude: -6.2297, Longitude: 106.8295},
...
func TestNearbyUser_Structure(t *testing.T) {
	user := &NearbyUser{
		ID:       "test-user-id",
		Location: Location{Latitude: -6.1751, Longitude: 106.8650},
		Distance: 2.5,
	}
