...
// UnifiedClient provides a simple HTTP client with API key support and basic retry
...
// UnifiedConfig holds configuration for the unified HTTP client
...
// NewUnifiedClient creates a new simplified HTTP client
func NewUnifiedClient(config UnifiedConfig) *UnifiedClient {
	if config.Timeout == 0 {
...
func (c *UnifiedClient) Do(ctx context.Context, method, endpoint string, body interface{}) (*http.Response, error) {
...
func (c *UnifiedClient) Get(ctx context.Context, endpoint string) (*http.Response, error) {
	return c.Do(ctx, "GET", endpoint, nil)
}

// Post performs a POST request
func (c *UnifiedClient) Post(ctx context.Context, endpoint string, body interface{}) (*http.Response, error) {
	return c.Do(ctx, "POST", endpoint, body)
}

// Put performs a PUT request
func (c *UnifiedClient) Put(ctx context.Context, endpoint string, body interface{}) (*http.Response, error) {
	return c.Do(ctx, "PUT", endpoint, body)
}

// Delete performs a DELETE request
func (c *UnifiedClient) Delete(ctx context.Context, endpoint string) (*http.Response, error) {
	return c.Do(ctx, "DELETE", endpoint, nil)
}

// GetJSON performs a GET request and decodes JSON response
func (c *UnifiedClient) GetJSON(ctx context.Context, endpoint string, result interface{}) error {
...
func (c *UnifiedClient) PostJSON(ctx context.Context, endpoint string, body, result interface{}) error {
...
func (c *UnifiedClient) PutJSON(ctx context.Context, endpoint string, body, result interface{}) error {
